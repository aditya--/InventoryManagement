...
<script type="text/javascript">
	function submit() {
		...
		if (!itemForm.itemName.value || !itemForm.itemQty.value) {

			$("#resultContainer")
					.html(
							"<div class='alert alert-danger' >Fields cannot be empty!</div>");
			return false;
		}
		...
		$
				.ajax({
					type : "POST",
					dataType : "json",
					url : "http://localhost:8181/InventoryManagement/Item",
